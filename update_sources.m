function sources_to_keep = update_sources(qs,sources,addhull_sources,conflictMatrix)
...
while ~isempty(sources_to_add)
    ...
    toadd  = add_one_source_c_pratik(int32(rest_of_sources'),int32(local_to_add),int32(qs),int32(conflictMatrix));
